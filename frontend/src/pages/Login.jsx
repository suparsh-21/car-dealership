        ...
        <div className="min-h-screen bg-[#0b0c10] text-[#f1f5f9] flex flex-col justify-between font-sans-clean">
            ...
            <nav className="flex items-center justify-between px-6 lg:px-12 py-6 border-b border-white/10 bg-[#0b0c10]">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <Link to="/register" className="hidden sm:inline-block text-xs font-bold text-gray-400 hover:text-[#d90429] transition uppercase tracking-wider">
            ...
            <div className="flex-1 flex items-center justify-center px-6 py-12">
                <div className="w-full max-w-md bg-[#141620] border border-white/10 p-8 sm:p-12 rounded-3xl shadow-2xl">
                    <div className="flex items-center justify-between mb-4">
                        ...
                        <span className="text-[#d90429] text-xs font-bold uppercase tracking-widest">Welcome Back</span>
                    </div>
                    
                    <div className="flex items-center justify-between mb-6">
                        <h1 className="font-serif-luxury text-4xl sm:text-5xl font-black text-white leading-tight">
                            Sign <span className="italic font-normal text-[#d90429]">In.</span>
                        </h1>
                        <button
                            type="button"
                            onClick={() => {
                            ...
                            className="px-3.5 py-1.5 bg-red-950/60 text-[#d90429] text-[11px] font-bold uppercase tracking-wider rounded-full border border-red-800/40 hover:bg-[#d90429] hover:text-white transition"
                        >
                            🔑 Fill Admin
                        </button>
                    </div>
